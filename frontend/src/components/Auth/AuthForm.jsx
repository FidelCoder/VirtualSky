...
// 
  const onInterestSelected = async (selectedInterests) => {
    ...
    try {
      await axios.post(`https://virtual-sky-servers.vercel.app/api/users/${authCtx.userId}/interests`, {
  ...
  const submitHandler = async (event) => {
    ...
    try {
      setIsLoading(true);
      const res = await fetch(isLogin ? 'https://virtual-sky-servers.vercel.app/login' : 'https://virtual-sky-servers.vercel.app/signup', {
        method: 'POST',
